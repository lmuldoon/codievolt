...
/* harmony export */ });
/* harmony import */ var _event_utilities__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./__event-utilities */ "./assets/src/js/scripts/__event-utilities.js");
...
function setUpHeader() {
  ...
  function storeHeaderHeight() {
    $('html').css('--header-height', "".concat(Math.ceil($siteHeader.outerHeight(true)), "px"));
  }
  storeHeaderHeight();
  $(window).on('resize', (0,_event_utilities__WEBPACK_IMPORTED_MODULE_0__.debounce)(storeHeaderHeight, 150));
  $(window).on('scroll', (0,_event_utilities__WEBPACK_IMPORTED_MODULE_0__.throttle)(storeHeaderHeight, 100));
}
function setUpFooter() {
  var $siteFooter = $('.site-footer');
  function storeFooterHeight() {
    $('html').css('--footer-height', "".concat(Math.ceil($siteFooter.outerHeight(true)), "px"));
  }
  storeFooterHeight();
}
...
function animateHero() {
  ...
  if (h1) {
    ...
    var wordInners = h1.querySelectorAll('.hero-word__inner');
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set(wordInners, {
      y: '115%'
    });
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(wordInners, {
      y: '0%',
      stagger: 0.055,
      duration: 0.75,
      ease: 'power3.out',
  ...
  // ── Eyebrow ───────────────────────────────────────────────────────────────
  if (eyebrow) {
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set(eyebrow, {
      opacity: 0,
      y: 18
    });
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(eyebrow, {
      opacity: 1,
      y: 0,
      duration: 0.6,
      ease: 'power2.out',
  ...
  // ── Sub-heading ───────────────────────────────────────────────────────────
  if (sub) {
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set(sub, {
      opacity: 0,
      y: 22
    });
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(sub, {
      opacity: 1,
      y: 0,
      duration: 0.7,
      ease: 'power2.out',
  ...
  // ── CTA buttons ───────────────────────────────────────────────────────────
  if (actions) {
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set(actions.children, {
      opacity: 0,
      y: 16
    });
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(actions.children, {
      opacity: 1,
      y: 0,
      stagger: 0.1,
      duration: 0.6,
  ...
  // ── Header drop-in ────────────────────────────────────────────────────────
  var headerInner = document.querySelector('.js-site-header .site-header__inner');
  if (headerInner) {
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.from(headerInner, {
      y: -40,
      opacity: 0,
      duration: 0.9,
      ease: 'power2.out',
...
function animateElements() {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.utils.toArray(".animated").forEach(function (elem) {
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set(elem.children, {
      opacity: 0
    });
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.create({
      ...
      onEnter: function onEnter() {
        gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.fromTo(elem.children, {
          x: 40,
          opacity: 0
        }, {
          x: 0,
      ...
      onEnterBack: function onEnterBack() {
        gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(elem.children, {
          duration: 0.3,
          opacity: 1,
          stagger: 0.05
        });
  ...
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.utils.toArray(".animated-up").forEach(function (elem) {
    ...
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.create({
      ...
      onEnter: function onEnter() {
        gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.fromTo(children, {
          y: 40,
          opacity: 0
        }, {
          y: 0,
      ...
      onEnterBack: function onEnterBack() {
        gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(children, {
          opacity: 1,
          duration: 0.3,
          stagger: 0.05
        });
...
function animateContactSection() {
  ...
  if (!layout) return;
  var _layout$children = _slicedToArray(layout.children, 2),
    intro = _layout$children[0],
    formWrapper = _layout$children[1];
  if (!intro || !formWrapper) return;
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set([intro, formWrapper], {
    opacity: 0,
    y: 45
  });
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.create({
    ...
    once: true,
    onEnter: function onEnter() {
      gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(intro, {
        opacity: 1,
        y: 0,
        duration: 0.8,
        ease: 'power3.out'
      });
      gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(formWrapper, {
        opacity: 1,
        y: 0,
        duration: 0.8,
        ease: 'power3.out',
...
function initLightningStrikes() {
  var rightEl = document.getElementById('js-lightning-right');
  var leftEl = document.getElementById('js-lightning-left');
  ...
  function runLoop() {
    var el = nextSide === 0 ? rightEl : leftEl;
    nextSide = 1 - nextSide;
    strike(el, function () {
      // Random pause before the opposite side fires
      gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.delayedCall(gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.utils.random(2.5, 5.5), runLoop);
    });
  }

  // First strike fires after hero text has settled
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.delayedCall(2, runLoop);
}
...
/***/ "./assets/src/js/scripts/header-collapse.js":
/*!**************************************************!*\
  !*** ./assets/src/js/scripts/header-collapse.js ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   HeaderStateController: function() { return /* binding */ HeaderStateController; }
/* harmony export */ });
/* harmony import */ var _event_utilities__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./__event-utilities */ "./assets/src/js/scripts/__event-utilities.js");
...
function init() {
  updateState();
  $(window).scroll((0,_event_utilities__WEBPACK_IMPORTED_MODULE_0__.throttle)(function (event) {
    updateState();
  }, 25));
}
function updateState() {
  ...
  var newState = $(window).scrollTop() > 70 ? 'collapsed' : 'expanded';
  if (state != newState) {
...
/***/ "./assets/src/js/scripts/nav-toggle.js":
/*!*********************************************!*\
  !*** ./assets/src/js/scripts/nav-toggle.js ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MenuController: function() { return /* binding */ MenuController; }
/* harmony export */ });
...
function openMenu() {
  ...
  var $items = $('#js-mobile-nav .site-menu > li');
  $hamburger.addClass('is-active').attr('aria-expanded', 'true');
  $nav.attr('aria-hidden', 'false');
  (0,body_scroll_lock__WEBPACK_IMPORTED_MODULE_1__.disableBodyScroll)($nav[0], {
    reserveScrollBarGap: true
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set($nav[0], {
    visibility: 'visible',
    pointerEvents: 'auto'
  });
...
function closeMenu() {
  ...
  (0,body_scroll_lock__WEBPACK_IMPORTED_MODULE_1__.enableBodyScroll)($nav[0]);

  // Close any open mobile sub-menus
  $('.js-mobile-sub-trigger[aria-expanded="true"]').each(function () {
    var $sub = $(this).next('.mobile-sub');
...
function initDropdown() {
  var $triggers = $('.has-dropdown');
  $triggers.each(function () {
    var $wrap = $(this);
    var $trigger = $wrap.find('.site-menu__dropdown-trigger');
    var $dropdown = $wrap.find('.site-dropdown');
    var closeTimer = null;
    function showDropdown() {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo($dropdown[0], {
        opacity: 0,
        y: -8
      }, {
        opacity: 1,
    ...
    function hideDropdown() {
      closeTimer = setTimeout(function () {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to($dropdown[0], {
          opacity: 0,
          y: -6,
          duration: 0.18,
          ease: 'power2.in',
...
function initMobileSubMenus() {
  $(document).on('click', '.js-mobile-sub-trigger', function () {
    var $trigger = $(this);
    var $sub = $trigger.next('.mobile-sub');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   IconifyIconComponent: function() { return /* binding */ IconifyIconComponent; },
/* harmony export */   _api: function() { return /* binding */ _api; },
/* harmony export */   addAPIProvider: function() { return /* binding */ addAPIProvider; },
/* harmony export */   addCollection: function() { return /* binding */ addCollection; },
/* harmony export */   addIcon: function() { return /* binding */ addIcon; },
/* harmony export */   appendCustomStyle: function() { return /* binding */ appendCustomStyle; },
/* harmony export */   buildIcon: function() { return /* binding */ buildIcon; },
/* harmony export */   calculateSize: function() { return /* binding */ calculateSize; },
/* harmony export */   disableCache: function() { return /* binding */ disableCache; },
/* harmony export */   enableCache: function() { return /* binding */ enableCache; },
...
/*!*********************************!*\
  ...
  \*********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _scripts_event_utilities__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scripts/__event-utilities */ "./assets/src/js/scripts/__event-utilities.js");
/* harmony import */ var iconify_icon__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! iconify-icon */ "./node_modules/iconify-icon/dist/iconify-icon.mjs");
...
/* harmony import */ var _scripts_header_collapse__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scripts/header-collapse */ "./assets/src/js/scripts/header-collapse.js");
/* harmony import */ var _scripts_nav_toggle__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scripts/nav-toggle */ "./assets/src/js/scripts/nav-toggle.js");
/* harmony import */ var _scripts_animations__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./scripts/animations */ "./assets/src/js/scripts/animations.js");




_scripts_header_collapse__WEBPACK_IMPORTED_MODULE_3__.HeaderStateController.init();

_scripts_nav_toggle__WEBPACK_IMPORTED_MODULE_4__.MenuController.init();

(0,_scripts_animations__WEBPACK_IMPORTED_MODULE_5__.initAnimations)();
...
$(window).on('resize', (0,_scripts_event_utilities__WEBPACK_IMPORTED_MODULE_0__.debounce)(function () {
  storeHeaderAndFooterHeight();
}, 150));
$(window).on('scroll', (0,_scripts_event_utilities__WEBPACK_IMPORTED_MODULE_0__.debounce)(function () {
  storeHeaderAndFooterHeight();
}, 100));
...
(function ($) {
  $('a[href*="#"]').not('[href="#"]').not('[href="#0"]').not('[role="tab"]').on('click', function (event) {
    if (location.pathname.replace(/^\//, '') === this.pathname.replace(/^\//, '') && location.hostname === this.hostname) {
      ...
      var headerHeight = Math.ceil($header.outerHeight(true));
      $header.removeClass('is-measuring');
      $('html, body').animate({
        scrollTop: target.offset().top - headerHeight + 1
      }, 400, function () {
        var heading = $(target[0]).find('h2').get(0);
        if (!heading) return;
        heading.focus({
          preventScroll: true
        });
...
(function ($) {
  ...
  var SITE_KEY = '6LcHo80sAAAAAGevrlghKLg-U_wScxNdCSrw3xNJ';
  $form.on('submit', function (e) {
    e.preventDefault();
    var $status = $form.find('.js-form-status');
    ...
    function doSubmit(token) {
      ...
      $.ajax({
        ...
        if (res.success) {
          ...
          var msg = res.errors && res.errors.length ? res.errors.join(' ') : 'Something went wrong. Please try again.';
          $status.addClass('is-error').text(msg).show();
        }
      }).fail(function (xhr) {
        var res = xhr.responseJSON;
        var msg = res && res.errors && res.errors.length ? res.errors.join(' ') : 'Something went wrong. Please try again.';
        $status.addClass('is-error').text(msg).show();
      }).always(function () {
